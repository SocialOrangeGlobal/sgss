...
export const metadata: Metadata = {
  title: 'Present Granthis | Sri Guru Singh Sabha Craigieburn',
  description: 'Get information of your local Granthi Singhs.',
};

const people = [
  { alt: 'Head Granthi Bhai Sahib', src: '/images/news/news5.jpg', name: 'Head Granthi' },
  { alt: 'Assistant Granthi', src: '/images/news/news6.jpg', name: 'Assistant Granthi' },
];
        ...
        <div className="mx-2 md:mx-6 bg-white rounded-[8px] border border-[#cfcfcf] px-4 py-8 md:px-8 md:py-8">
          ...
          <div className="mb-4">
            ...
            <p className="mt-1 text-[15px]" style={{ color: '#e67e22' }}>
              Get information of your local Granthi Singhs.
            </p>
          </div>
